...
static void nvlua_register_editor(lua_State* L);
...
static void nvlua_register_editor(lua_State* L)
{
    lua_pushlightuserdata(L, (void*)nvapi->nv_get_config());
    lua_setglobal(L, "config");
    nvapi->nv_log("registered nvlua editor\n");
}
